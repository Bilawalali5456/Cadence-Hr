...
ALTER TABLE assets ADD COLUMN IF NOT EXISTS return_log JSONB DEFAULT NULL;
...
ALTER TABLE leave_requests ADD COLUMN IF NOT EXISTS status_changed_at TIMESTAMPTZ DEFAULT NOW();
ALTER TABLE leave_requests ADD COLUMN IF NOT EXISTS reviewed_by TEXT DEFAULT NULL;
...
ALTER TABLE short_leave_requests ADD COLUMN IF NOT EXISTS status_changed_at TIMESTAMPTZ DEFAULT NOW();
ALTER TABLE short_leave_requests ADD COLUMN IF NOT EXISTS reviewed_by TEXT DEFAULT NULL;
...
ALTER TABLE holidays ADD COLUMN IF NOT EXISTS created_by TEXT DEFAULT NULL;
